...
-- AddForeignKey
ALTER TABLE `Event_category` ADD CONSTRAINT `Event_category_categoryId_fkey` FOREIGN KEY (`categoryId`) REFERENCES `Categorie`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
