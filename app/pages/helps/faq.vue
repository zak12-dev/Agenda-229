...
<template>
  <div
    class="min-h-screen bg-gradient-to-br from-orange-200 via-white to-indigo-200 py-16 px-6 mt-10"
  >
    <div class="max-w-4xl mx-auto space-y-12">
      ...
      <div class="text-center pt-12 border-t border-gray-200">
        ...
        <NuxtLink
          to="/contact"
          class="inline-block px-6 py-3 bg-gray-900 hover:bg-gray-800 text-white rounded-lg font-medium transition-all"
        >
          Nous contacter
        </NuxtLink>
      </div>
