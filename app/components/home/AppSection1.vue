<template>
  <div class="w-full bg-gradient-to-br from-purple-200 via-white to-indigo-200 py-12 sm:py-16 lg:py-20 ">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6 ">
          ...
          <div class="relative">
            ...
            >
              ...
              <svg class="w-4 h-4 transition-transform" :class="{ 'rotate-180': activeDropdown === 'category' }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div class="relative">
            ...
            >
              ...
              <svg class="w-4 h-4 transition-transform" :class="{ 'rotate-180': activeDropdown === 'date' }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
              </svg>
            </button>
          ...
          <div class="relative">
            ...
            >
              ...
              <svg class="w-4 h-4 transition-transform" :class="{ 'rotate-180': activeDropdown === 'location' }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
              </svg>
            </button>
...
<div class=" px-10 mt-16">
  ...
  <div class="flex items-center justify-between mb-6">
    <div>
      <h3 class="text-5xl font-semibold text-gray-900">
        {{ filteredEvents.length > 0 ? `${filteredEvents.length} événements trouvés` : 'Événements à la une' }}
      </h3>
  ...
  <div v-if="loading" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    <div v-for="i in 3" :key="i" class="bg-white rounded-2xl overflow-hidden shadow-lg animate-pulse">
  ...
  <!-- Grid des événements -->
  <div v-else-if="displayedEvents.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <NuxtLink :to="`/events/${event.id}`">
        ...
        <div class="relative overflow-hidden h-64">
          ...
          <div class="absolute top-4 left-4">
            <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold bg-white/90 backdrop-blur-md text-gray-900 shadow-lg">
          ...
          <div class="absolute top-4 right-4">
            <div class="flex flex-col items-center px-3 py-2 rounded-xl bg-white shadow-lg">
              <span class="text-2xl font-bold text-purple-600">{{ formatDay(event.date) }}</span>
              <span class="text-xs font-medium text-gray-600 uppercase">{{ formatMonth(event.date) }}</span>
            </div>
          </div>
        ...
        <div class="p-6">
          ...
          <div class="flex items-center justify-between pt-4 border-t border-gray-100">
            ...
            <!-- CTA Arrow -->
            <div class="w-10 h-10 rounded-full bg-purple-100 flex items-center justify-center group-hover:bg-gradient-to-r group-hover:from-purple-600 group-hover:to-indigo-600 transition-all">
              <svg class="w-5 h-5 text-purple-600 group-hover:text-white group-hover:translate-x-0.5 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  <!-- Bouton Voir Plus -->
  <div v-if="!loading && hasMoreEvents" class="text-center mt-10">
    <button
      @click="goToEvents()"
...
const events = ref([
  ...
  },
  {
    ...
    price: 0,
    duration: '1 journée',
    description: 'Découvrez les meilleurs plats et chefs locaux.',
  ...
  },
  {
    ...
    category: 'Expositions & Musées',
    date: '2026-03-01',
    location: 'Marseille',
    price: 15,
    duration: '2h',
    description: 'Une immersion dans l’art contemporain africain.',
...
const displayedEvents = computed(() => {
  return filteredEvents.value.slice(0, 6)
})
...
const hasActiveFilters = computed(() => {
  return selectedCategory.value || selectedDate.value || selectedLocation.value || selectedPrice.value
})
