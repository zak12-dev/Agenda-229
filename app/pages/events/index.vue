<template>
  ...
  <AppHeader />
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 ">
      ...
      <div class="bg-white rounded-3xl shadow-2xl shadow-purple-100/50 p-4 sm:p-6 lg:p-8 border border-gray-200">
...
const filteredEvents = computed(() => {
  return events.value.filter((event) => {
    ...
    const matchCategory = !selectedCategory.value || event.category === selectedCategory.value
